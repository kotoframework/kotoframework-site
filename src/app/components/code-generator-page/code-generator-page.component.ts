...
class ${serviceName} {
    fun create${className}(${classNameLower}: ${className + this.kPojoSuffix}): KotoExecuteResult {
        create(${classNameLower}).onId().execute()
    }

    fun remove${className}(id: Int) {
        remove(${className + this.kPojoSuffix}).soft().byId().execute()
    }

    fun update${className}(${classNameLower}: ${className + this.kPojoSuffix}) {
        update(${classNameLower}).byId().execute()
    }
